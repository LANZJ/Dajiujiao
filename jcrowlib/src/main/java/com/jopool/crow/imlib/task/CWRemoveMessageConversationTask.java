...
public class CWRemoveMessageConversationTask extends NetAbstractTask<String> {
    public CWRemoveMessageConversationTask(Context context) {
        super(context);
    ...
    protected Result<String> onHttpRequest(Object... params) {
        ...
        paramMap.put("toId" , (String)params[0]);
        paramMap.put("toType" , (String)params[1]);
        paramMap.put("ownerUserId" , CWUser.getConnectUserId());


        Result<String> result = null;
        try {
            CWHttpUtil.CWResponse response = CWHttpUtil.post(CWChat.getInstance().getConfig().getApiPrefix() + UrlConstants.REMOVE_MESSAGE_CONVERSATION
                    , paramMap);
    ...
    public static void removeConversation(Context context , String toId , String toType){
        CWRemoveMessageConversationTask removeMessageConversationTask = new CWRemoveMessageConversationTask(context);
        removeMessageConversationTask.setAsyncTaskFailCallback(new AsyncTaskFailCallback<String>() {
            @Override
        ...
        removeMessageConversationTask.setAsyncTaskSuccessCallback(new AsyncTaskSuccessCallback<String>() {
            @Override
        ...
        removeMessageConversationTask.execute(toId , toType);
    }
}
