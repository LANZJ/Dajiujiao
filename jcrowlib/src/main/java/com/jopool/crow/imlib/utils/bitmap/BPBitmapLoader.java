...
import com.jopool.crow.imlib.utils.bitmap.core.impl.local.LocalBitmapLoader;
import com.jopool.crow.imlib.utils.bitmap.core.impl.net.NetBitmapLoader;
...
public class BPBitmapLoader implements IBitmapLoader {
	...
	public void display(ImageView imageView, String url,
		...
		} else if (CWValidator.isNumber(url)) {
			// 资源图片
