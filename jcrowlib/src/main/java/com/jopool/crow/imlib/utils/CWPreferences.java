 ...
 *          2012) $
 */
public class CWPreferences {
	private SharedPreferences prefs;
	private Editor prefsEdit;
	private static CWPreferences instance;

	private CWPreferences() {
	}
	 ...
	 * @return
	 */
	public static CWPreferences instance() {
		if (null == instance) {
			instance = new CWPreferences();
			instance.prefs = PreferenceManager
					.getDefaultSharedPreferences(CWChat.getApplication());
		}
		return instance;
	}
