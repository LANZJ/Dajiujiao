package com.jopool.crow.imkit.utils.pinyin;
 ...
 */
public abstract class CWPinyinUtil {
	private static final String TAG = CWPinyinUtil.class.getSimpleName();
	...
	public static String toPinyin(char c) {
		...
		try {
			is = new RandomAccessFile(CWPinyinSource.getFile(), "r");
			long sp = (c - 0x4E00) * 6;
			is.seek(sp);
			byte[] buf = new byte[6];
			is.read(buf);
