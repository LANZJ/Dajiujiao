 ...
 * @author xuan
 */
public class CWPopViewLayout extends RelativeLayout {
	private final static String TAG = "BUPopViewLayout";
	 ...
	 * @param context
	 */
	public CWPopViewLayout(Context context) {
		super(context);
		init();
	}
	 ...
	 * @param attrs
	 */
	public CWPopViewLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	 ...
	 * @param defStyle
	 */
	public CWPopViewLayout(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param resId
	 */
	public CWPopViewLayout setContentView(int resId) {
	 ...
	 * @return
	 */
	public CWPopViewLayout setContentView(View view) {
		this.mPopView = view;
		resetView();
		resetAnima();
	 ...
	 * @return
	 */
	public CWPopViewLayout setPopMode(int popMode) {
	...
	private boolean isInContentView(MotionEvent event) {
		...
		Log.d(TAG, "isInContentView:" + isIn);
		return isIn;
	}
