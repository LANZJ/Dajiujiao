...
public class CWConversationVolumeView extends CWBaseLayout {
	...
	public CWConversationVolumeView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public void changeState(int state) {
		...
		case STATE_PREPARE:
			...
			messageTv.setBackgroundColor(getResources().getColor(
					R.color.cw_color_transparent));
			imageIv.setImageResource(R.drawable.cw_chat_volume_prepare);
		...
		case STATE_SLIDE_UP_CANCEL:
			...
			messageTv.setBackgroundColor(getResources().getColor(
					R.color.cw_color_transparent));
			imageIv.setImageResource(R.drawable.cw_chat_volume_1);
			setVisibility(View.VISIBLE);
			break;
		case STATE_RELEASE_UP_CALCEL:
			...
			messageTv.setBackgroundColor(getResources().getColor(
					R.color.cw_color_chat_volume_message_bg));
			imageIv.setImageResource(R.drawable.cw_chat_volume_cancel);
			setVisibility(View.VISIBLE);
			break;
		case STATE_TOAST_TOO_SHOT:
			...
			messageTv.setBackgroundColor(getResources().getColor(
					R.color.cw_color_transparent));
			imageIv.setImageResource(R.drawable.cw_chat_volume_tooshot);
			setVisibility(View.VISIBLE);
