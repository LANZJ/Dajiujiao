 ...
 * @author xuan
 */
public class CWSingleSelectDialog extends Dialog {
	private final Activity mActivity;
	private View mContentView;
	private ListView mListView;

	public CWSingleSelectDialog(Context context) {
		super(context);
	...
	public static class Builder {
		...
		public CWSingleSelectDialog create() {
			final CWSingleSelectDialog dialog = new CWSingleSelectDialog(
					activity);
			if (!CWValidator.isEmpty(itemTexts)) {
				dialog.mListView.setAdapter(new CWBaseAdapter() {
					@Override
