 ...
 */
public class CashApplyTask extends BaseTask<NoResultData> {
    public CashApplyTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        paramMap.put("cashAccountId" , (String)params[0]);
        paramMap.put("amount" , (String)params[1]);
        paramMap.put("type" , (String)params[2]);

        Result<NoResultData> result = postCommon(UrlConstants.CASHAPPLY , paramMap);
        if (result.isSuccess()){
