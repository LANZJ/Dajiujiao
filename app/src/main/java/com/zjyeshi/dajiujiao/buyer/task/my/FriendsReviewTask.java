 ...
 */
public class FriendsReviewTask extends BaseTask<NoResultData> {
    public FriendsReviewTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        paramMap.put("isAdopt" , (String)params[1]);

        Result<NoResultData> result = postCommon(UrlConstants.FRIENDREVIEW , paramMap);
        if (result.isSuccess()){
