...
import com.zjyeshi.dajiujiao.buyer.activity.rong.ui.LoadingDialog;
...
public class ConversationListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp = getSharedPreferences("rongToken", MODE_PRIVATE);
        ...
        if (intent.getData().getScheme().equals("rong") && intent.getData().getQueryParameter("push") != null) {
            ...
            if (RongIM.getInstance().getCurrentConnectionStatus().equals(RongIMClient.ConnectionStatusListener.ConnectionStatus.DISCONNECTED)) {
               ...
               startActivity(new Intent(ConversationListActivity.this, MianFramActivity.class));
                finish();
            }
        }
    }
    ...
    private void reconnect(String token) {
        RongIM.connect(token, new RongIMClient.ConnectCallback() {
            ...
            public void onSuccess(String s) {
                ...
                if (mDialog != null)
                    mDialog.dismiss();
                startActivity(new Intent(ConversationListActivity.this, WorkActivity.class));
                finish();
            }
