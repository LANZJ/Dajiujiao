 ...
 */
public class ModifyTimeCardRemarkTask extends BaseTask<NoResultData> {
    public ModifyTimeCardRemarkTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        paramMap.put("remark"  , (String)params[1]);

        Result<NoResultData> result = postCommon(UrlConstants.MODIFYTIMECARDREMARK , paramMap);
        if (result.isSuccess()){
