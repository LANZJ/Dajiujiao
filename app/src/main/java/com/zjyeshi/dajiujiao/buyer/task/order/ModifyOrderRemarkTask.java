 ...
 */
public class ModifyOrderRemarkTask extends BaseTask<NoResultData> {
    public ModifyOrderRemarkTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result = postCommon(UrlConstants.MODIFYORDERREMARK , paramMap);
        if (result.isSuccess()){
