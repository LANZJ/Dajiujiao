 ...
 */
public class PassLeaveTask extends BaseTask<NoResultData> {
    public PassLeaveTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result = postCommon(UrlConstants.APPROVALLEAVE , paramMap);
        if (result.isSuccess()){
