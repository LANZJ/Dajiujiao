 ...
 */
public class TransferReviewTask extends BaseTask<NoResultData> {
    public TransferReviewTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result  = postCommon(UrlConstants.TRANSFERREVIEW , paramMap);
        if (result.isSuccess()){
