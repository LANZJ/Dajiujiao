 ...
 */
public class OrderNextTask extends BaseTask<NoResultData> {
    public OrderNextTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result = postCommon(UrlConstants.ORDERNEXT , paramMap);
        if (result.isSuccess()){
