...
private String createId;
    ...
    public CWGroupInfoUserAdapter(Context context, List<CWSelectUser> dataList, String groupId,String createId ) {
        ...
        if (position == dataList.size()) {
            ...
            avatarIv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    CWChat.getInstance().getGroupDelegate().startSelectWhenAdd(context, groupId, dataList,createId);
                }
            });
            ...
            avatarIv.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    CWChat.getInstance().getGroupDelegate().startSelectWhenRemove(context, groupId, dataList,createId);
