 ...
 */
public class MarketGoodsCarDao extends BPBaseDao {
    private final String SQL_FIND_ALL_GOODS_BY_USERID = "SELECT * FROM market_goods_car WHERE owner_user_id = ?";
    private final String SQL_DELETE_BY_ID_AND_USEID =  "DELETE FROM market_goods_car WHERE good_id = ? AND owner_user_id = ?";
    private final String SQL_FIND_BY_SHOPID_AND_USEID =  "SELECT * FROM market_goods_car WHERE shop_id=? AND owner_user_id = ?";
    private final String SQL_FIND_BY_GOODID_AND_USEID =  "SELECT * FROM market_goods_car WHERE good_id=? AND owner_user_id = ?";
    private final String SQL_FIND_BY_STATUS_AND_USEID =  "SELECT * FROM market_goods_car WHERE status=? AND owner_user_id = ?";
    private final String SQL_REPLACE = "insert or replace INTO market_goods_car(shop_id,good_id,shop_name,good_name,good_icon,good_count,good_type,good_price,good_per_box,good_up_price,status,good_market_price,owner_user_id) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
    private final String SQL_FIND_SHOP_BY_USEID = "SELECT shop_id,shop_name FROM market_goods_car WHERE owner_user_id = ? GROUP BY shop_id";
    ...
    public List<CarShop> findAllShopList() {
        ...
        String ownerUserId= LoginedUser.getLoginedUser().getId();
        return bpQuery(SQL_FIND_SHOP_BY_USEID, new String[] {ownerUserId},
    ...
    public List<GoodsCar> findGoodListByShopId(String shopId) {
        ...
        String ownerUserId= LoginedUser.getLoginedUser().getId();
        return bpQuery(SQL_FIND_BY_SHOPID_AND_USEID, new String[] {shopId , ownerUserId}, new MMultiRowMapper());
    }
    ...
    public List<GoodsCar> findGoodListByStatus() {
        ...
        String ownerUserId = LoginedUser.getLoginedUser().getId();
        return bpQuery(SQL_FIND_BY_STATUS_AND_USEID, new String[] {String.valueOf(SelectEnum.SELECTED.getValue()) , ownerUserId}, new MMultiRowMapper());
    }
    ...
    public GoodsCar findByGoodId(String goodId) {
        ...
        String ownerUserId= LoginedUser.getLoginedUser().getId();
        return bpQuery(SQL_FIND_BY_GOODID_AND_USEID,
    ...
    public void deleteById(String goodId) {
        ...
        String ownerUserId= LoginedUser.getLoginedUser().getId();
        bpUpdate(SQL_DELETE_BY_ID_AND_USEID, new String[]{goodId , ownerUserId});
    }
