 ...
 */
public class RefuseLeaveTask extends BaseTask<NoResultData> {
    public RefuseLeaveTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result = postCommon(UrlConstants.REFUSELEAVE , paramMap);
        if (result.isSuccess()){
