 ...
 */
public class CancelCollectionTask extends BaseTask<NoResultData> {
    public CancelCollectionTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result = postCommon(UrlConstants.CANCELMYCOLLECTION , paramMap);
        if (result.isSuccess()){
