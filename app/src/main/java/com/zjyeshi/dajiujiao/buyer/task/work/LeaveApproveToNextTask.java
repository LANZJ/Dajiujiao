 ...
 */
public class LeaveApproveToNextTask extends BaseTask<NoResultData> {
    public LeaveApproveToNextTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result = postCommon(UrlConstants.LEAVEAPPROVETONEXT , paramMap);
        if (result.isSuccess()){
