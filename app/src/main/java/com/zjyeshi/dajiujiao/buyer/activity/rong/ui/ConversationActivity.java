...
import com.zjyeshi.dajiujiao.buyer.activity.rong.ap.ConversationFragmentEx;
import com.zjyeshi.dajiujiao.buyer.activity.rong.ap.NLog;
 ...
 * 3，push 和 通知 判断
 */
public class ConversationActivity extends ZjActivity implements View.OnClickListener {
...
//        });
    ...
    private void enterSettingActivity() {
       ...
       //         intent.putExtra("conversationType", Conversation.ConversationType.GROUP);
                ...
                intent.putExtra(MEMBERID, mTargetId);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                getApplicationContext().startActivity(intent);

            } else if (mConversationType == Conversation.ConversationType.DISCUSSION) {
                intent = new Intent();
                intent.setClass(this, CWGroupDetailActivity.class);
                intent.putExtra(CWGroupDetailFragment.PARAM_GROUP_ID, mTargetId);
