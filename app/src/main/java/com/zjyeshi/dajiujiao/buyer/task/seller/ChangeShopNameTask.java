 ...
 */
public class ChangeShopNameTask extends BaseTask<NoResultData> {
    public ChangeShopNameTask(Context context) {
        super(context);
    }
...
//        paramMap.put("openTime" , (String)params[4]);
//        paramMap.put("closeTime" , (String)params[5]);
