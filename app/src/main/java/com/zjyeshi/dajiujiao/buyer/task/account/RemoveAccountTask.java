 ...
 */
public class RemoveAccountTask extends BaseTask<NoResultData> {
    public RemoveAccountTask(Context context) {
        super(context);
    }
    ...
    protected Result<NoResultData> onHttpRequest(Object... params) {
        ...
        Result<NoResultData> result = postCommon(UrlConstants.REMOVEACCOUNT , paramMap);
        if (result.isSuccess()){
